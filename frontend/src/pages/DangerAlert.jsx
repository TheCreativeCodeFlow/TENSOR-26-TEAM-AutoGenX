  ...
  return (
    <div className="px-4 py-4 md:px-6">
      <div className="rounded-[32px] bg-[linear-gradient(135deg,#7c000a,#c53030)] p-6 text-white shadow-lg md:p-8">
        <p className="text-xs font-black uppercase tracking-[0.35em] text-white/70">Danger</p>
        <h1 className="mt-2 text-4xl font-black uppercase">No-go zone</h1>
        <p className="mt-3 max-w-2xl text-lg font-medium text-white/90">
          {advisory?.preferredMessage || advisory?.summary?.en || "Conditions unsafe. Stay in port."}
        </p>
        <div className="mt-5 flex flex-wrap gap-3">
          <button onClick={read} className="rounded-full bg-white px-5 py-3 text-sm font-black uppercase tracking-[0.2em] text-tertiary">
            Read warning
          </button>
